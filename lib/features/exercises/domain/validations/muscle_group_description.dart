...
class MuscleGroupDescription extends Validation<String> {
  ///
  factory MuscleGroupDescription(String input) {
    return MuscleGroupDescription._(
      _validate(input),
    );
  }

  const MuscleGroupDescription._(this._value);
  @override
